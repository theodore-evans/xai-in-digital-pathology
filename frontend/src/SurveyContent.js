...
export const CONTENT = {
  ...
  instructionsHTML: `<p>Dear participant,</p>
    ...
    <p>For each question, we show a different explanation that aims to help you with evaluating these generated annotations. Please <b>rate each proposed explanation</b> with regard to its comprehensibility, informativeness and value to you as a user. <b>Do not </b>rate the annotations generated by the AI solution.</p>
    <p>We estimate a <b>time of five minutes</b> for fully answering the study.</p>
    ...
    This survey does not raise any ethical issues. By clicking 'complete', you agree to the use of your submitted answers for these purposes.</p>
    ...
    ratingQuestions: [
      {
        id: "aiFamiliarity",
        title:
          "I am familiar with the use of AI applications in digital pathology",
      },
      {
        id: "mlFamiliarity",
